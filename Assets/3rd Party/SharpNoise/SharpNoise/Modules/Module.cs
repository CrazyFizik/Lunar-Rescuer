...
namespace SharpNoise.Modules
{
    ...
    public abstract class Module
    {
        ...
        {
            System.Diagnostics.Debug.Assert(sourceModules != null);
        ...
        public virtual Module this[int index]
        {
            get
            {
                System.Diagnostics.Debug.Assert(sourceModules != null);
                System.Diagnostics.Debug.Assert(sourceModules.Length > 0);
                if (index < 0 || index >= sourceModules.Length)
                {
