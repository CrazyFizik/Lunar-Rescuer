...
namespace SharpNoise.Modules
{
    ...
    public class RidgedMulti : Module
    {
        ...
        /// Deafult gain
        /// </summary>
        public const double DeafultGain = 2D;

        /// <summary>
        /// Deafult spectral exponent
        /// </summary>
        public const double DeafulExponent = 1D;

        /// <summary>
        /// Deafult offset
        /// </summary>
        public const double DeafultOffset = 1D;
            ...
            : base(0)
        {
            ...
            Gain = DeafultGain;
            SpectralWeightsExponent = DeafulExponent;
        ...
        protected void CalcSpectralWeights()
        {
            ...
            _spectralWeights = new double[MaxOctaves];
