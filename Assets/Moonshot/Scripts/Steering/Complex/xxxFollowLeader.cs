...
{
    [System.Serializable]
    public class xxxFollowLeader : SteeringBehaviour
    {
        ...
        public float _LEADER_BEHIND_DIST = 1f;
        ...
        public override void Update()
        {
            ...
            if (_leader != null)
            {
                ...
                _arrive.Update();
                follow = _arrive._WEIGHT * _arrive._steering;

                // Evade from leader path
                ...
                if (ld2 < r2 || ad2 < r2)
                {
                    ...
                    _evade.Update();
                    evade = _evade._WEIGHT * _evade._steering;
                }
            }

            //_separation._boids = _flockers;
            _separation.Update();
            separate = _separation._WEIGHT * _separation._steering;

            //_aligement._boids = _flockers;
            _aligement.Update();
            aligement = _aligement._direction;
