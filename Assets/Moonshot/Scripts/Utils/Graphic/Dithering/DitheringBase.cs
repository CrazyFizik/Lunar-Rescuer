...
public abstract class DitheringBase {
    ...
    public static Color TrueColorToWebSafeColor(Color inputColor)
    {
        Color returnColor = new Color(
            Mathf.Clamp01((Mathf.FloorToInt((inputColor.r * 255) / 51.0f) * 51) / 255.0f),
    ...
    public static Color TrueColorToRGBA4444(Color inputColor)
    {
        Color returnColor = new Color(
            Mathf.Clamp01((Mathf.FloorToInt((inputColor.r * 255) / 16.0f) * 16) / 255.0f),
    ...
    public static Color TrueColorToRGBA32(Color inputColor)
    {
        Color returnColor = new Color(
            Mathf.Clamp01((Mathf.FloorToInt((inputColor.r * 255) / 1.0f) * 1) / 255.0f),
            Mathf.Clamp01((Mathf.FloorToInt((inputColor.g * 255) / 1.0f) * 1) / 255.0f),
            Mathf.Clamp01((Mathf.FloorToInt((inputColor.b * 255) / 1.0f) * 1) / 255.0f),
            Mathf.Clamp01((Mathf.FloorToInt((inputColor.a * 255) / 1.0f) * 1) / 255.0f));
