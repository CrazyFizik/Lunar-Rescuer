...
namespace Assets.Moonshot.Scripts.Audio
{
    /// <summary>
    /// Source: https://assetstore.unity.com/packages/audio/music/flexible-music-manager-73866 
    /// </summary>
    ...
    public class FlexibleMusicManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            if (dontDestroyOnLoad)
            {
                ...
                {
                    Debug.LogError("Duplicate singleton " + gameObject + " created; destroying it now");
                    Destroy(gameObject);
                }
